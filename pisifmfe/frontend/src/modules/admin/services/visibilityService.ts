...
const STATIC_REGISTRY: DataItem[] = [
  ...
  // Plant Overviews
  { id: 'gp1', key: 'GLOBAL_PLANT_CIKOKOL', label: 'Overview Plant Cikokol', category: VisibilityCategory.GLOBAL_DASHBOARD, group: VisibilityGroup.LIST, location: 'Global Dashboard', defaultVisible: true, plantScopeId: 'cikokol' },
  { id: 'gp2', key: 'GLOBAL_PLANT_SEMARANG', label: 'Overview Plant Semarang', category: VisibilityCategory.GLOBAL_DASHBOARD, group: VisibilityGroup.LIST, location: 'Global Dashboard', defaultVisible: true, plantScopeId: 'semarang' },
  { id: 'gp3', key: 'GLOBAL_PLANT_CIKUPA', label: 'Overview Plant Cikupa', category: VisibilityCategory.GLOBAL_DASHBOARD, group: VisibilityGroup.LIST, location: 'Global Dashboard', defaultVisible: true, plantScopeId: 'cikupa' },
  { id: 'gp4', key: 'GLOBAL_PLANT_AGRO', label: 'Overview Plant Agro', category: VisibilityCategory.GLOBAL_DASHBOARD, group: VisibilityGroup.LIST, location: 'Global Dashboard', defaultVisible: true, plantScopeId: 'agro' },
